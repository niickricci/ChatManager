...
namespace ChatManager.Models
{
    ...
    public class Repository<T>
    {
        ...
        public virtual bool Update(T data)
        {
            ...
            try
            {
                if (typeof(T) == typeof(UsersLogsJournal))
                {
                    UsersLogsJournal dataToUpdate = data as UsersLogsJournal;

                    if (dataToUpdate != null)
                    {
                        UsersLogsJournal lastLogin = dataList
                            .OfType<UsersLogsJournal>()
                            .Where(l => l.UserID == dataToUpdate.UserID)
